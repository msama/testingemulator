...
/**
 * <P>Represents a single Contact entry in a PIM Contact database.
 ...
 * {@link PIMList#isSupportedField} and {@link PIMList#getSupportedAttributes}
 ...
 * Contact's ContactList result in a {@link UnsupportedFieldException}.
 * </P>
 * <H3>Data</H3>
...
public interface Contact extends PIMItem {
     ...
     * territory) of a particular address. Data for this field is of String type.
     */
    ...
    /**
    * Returns the index of the value marked with the attribute ATTR_PREFERRED
    * for the given field.  Only one value per field may be marked as preferred.
    ...
    * attribute validity for this item prior to invoking this method.
    *
    * @param    field the field to look for a preferred value
    * @return   an integer representing the index of the value that is marked
    *           as preferred.  -1 is returned if no values within the field are
    *           marked as preferred.
    * @throws   IllegalArgumentException if field is not a valid field for
    *           a Contact.
    * @throws   UnsupportedFieldException if the field is not supported by
