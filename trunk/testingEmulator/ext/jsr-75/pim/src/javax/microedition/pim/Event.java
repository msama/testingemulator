 ...
 * an event is determined by using a {@link RepeatRule} to calculate when the
 ...
 * {@link PIMList#isSupportedField} and {@link PIMList#getSupportedFields}
 ...
 * EventList result in a {@link UnsupportedFieldException}.
 * </P>
 * <H3>Data</H3>
 ...
 * determined by the method {@link PIMList#isSupportedField}.
 * </p><P>
 ...
 * </PRE>
 *
 * @see <A target=_top href="http://www.imc.org/pdi">Internet Mail Consortium PDI</A>
 * @see EventList
 * @since PIM 1.0
 */
...
public interface Event extends PIMItem {
	 ...
	 * reoccurrences of the event, the alarm is calculated by  substracting the
    ...
    /**
    * Retrieves a RepeatRule object specifying how often and when this event
    * occurs.  This method returns a copy of the RepeatRule object 
	* associated with the Event by the system.  Modifications to the returned 
	* object must be saved back to the Event via the <code>setRepeat</code>
	* method if they are to be persisted with the Event.
    *
    * @return   the RepeatRule describing how often this Event occurs or
    *           <code>null</code> if a RepeatRule has not been set.
    */
    public abstract RepeatRule getRepeat();

    /**
    * Sets the RepeatRule specifying how often and when this event occurs.  The
    * RepeatRule parameter is a hint to the system indicating the repeat pattern,
    * but does not have to be strictly enforced in the implementation.
    * The provided RepeatRule object replaces any previously set RepeatRule
	* object for the Event.
    *
    * @param    value A RepeatRule describing how often this Event occurs or
    *           <code>null</code> to clear any RepeatRule.
    */
