...
import ucl.cs.testingEmulator.vibration.VibrationManager;
...
public class Display 
{
	...
	public void setCurrent(Displayable nextDisplayable) 
	{
		if (nextDisplayable != null) {
			...
			if (nextDisplayable instanceof Alert) {
				...
				{
					Alert alert=(Alert)this.current;
					this.setCurrent((Alert) nextDisplayable, alert.nextDisplayable);
				}else{
	...
	public void setCurrent(Alert alert, Displayable nextDisplayable) 
	{
		...
		if (alert.getTimeout() != Alert.FOREVER) {
			...
			Thread t = new Thread(at,"AlertTimeout");
			t.start();
		}
	}
    ...
    { 
    	//begin modified code ********************************************
        //return false; 
        VibrationManager.getInstance().vibrate(Main.instance,duration);
        return true;
        //end modified code ********************************************** 
    }
